...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/lucky-mode-90b6)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/lucky-mode-90b6
```

A live public deployment of this template is available at [https://lucky-mode-90b6.templates.workers.dev](https://lucky-mode-90b6.templates.workers.dev)
